...
// Single primary pillar (Photography) + 1–3 specialties.
...
const portfolio = [
  { id: 1, cat: "Editorial & Press",                ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=700&q=80", title: "Spring drop · Aritzia" },
  { id: 2, cat: "Brand & Commercial Photography",   ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=900&q=80", title: "Soho House · Miami" },
  { id: 3, cat: "Headshots & Portraits",            ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1554384645-13eab165c24b?w=700&q=80", title: "Equinox · Member series" },
  { id: 4, cat: "Brand & Commercial Photography",   ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&q=80", title: "The Standard · Property" },
  { id: 5, cat: "Editorial & Press",                ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1496217590455-aa63a8350eea?w=700&q=80", title: "Vogue Business · Resort" },
  { id: 6, cat: "Brand & Commercial Photography",   ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=900&q=80", title: "Horizon Rebrand" },
  { id: 7, cat: "Headshots & Portraits",            ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=700&q=80", title: "Founder portraits" },
  { id: 8, cat: "Brand & Commercial Photography",   ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=900&q=80", title: "Editorial campaign" },
  { id: 9, cat: "Editorial & Press",                ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=700&q=80", title: "Coral Gables · feature" }
];
...
function Breadcrumb() {
  return (
    <div className="flex items-center gap-2 text-[11px] text-[var(--text-dim)] mb-6">
      ...
      <span className="opacity-40">/</span>
      <a href="Find Creators.html?pillar=photo" className="hover:text-[var(--text)] transition-colors">{creator.pillar.label}</a>
      <span className="opacity-40">/</span>
