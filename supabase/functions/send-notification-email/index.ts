  ...
  switch (template) {
    ...
    case 'delivery_submitted':
      ...
      bodyContent = `
        ...
        <p><em>You have five calendar days to approve, request a revision, or open a dispute. A revision or dispute pauses completion. If no action is taken, CreatorBridge automatically attempts the final payment; funds are only released after Stripe confirms it.</em></p>
      `;
      break;
    ...
    case 'final_paid':
      ...
      bodyContent = `
        ...
        <p>Hi ${data.creator_name || 'Creator'},</p>
        <p>The client has approved your content delivery (or the five-day review window has elapsed) for the project <strong>"${data.project_title || 'Project'}"</strong>.</p>
