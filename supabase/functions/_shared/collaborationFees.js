// Canonical collaboration fee math for the money-authoritative (backend) side.
// Kept in sync with src/config/collaborationFees.js (frontend copy); the
// scripts/verify-collaboration-fee-parity.mjs test fails if the two ever drift.
