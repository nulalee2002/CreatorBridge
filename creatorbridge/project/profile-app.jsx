// CreatorBridge — Creator Profile prototype
// Aria Vasquez · Aria Visual Studio · Miami FL
...
const creator = {
  ...
  bio: "I shoot for brands that want their work to feel deliberate. Studio and on-location, with a small reliable crew. Based in Miami, working nationally.",
  featuredIn: ["Vogue Business", "Harper's Bazaar", "Hypebeast", "Soho House Magazine"],
  specialties: ["Commercial", "Editorial", "Portrait", "Real Estate"],
  ...
  reel: "https://images.unsplash.com/photo-1485846234645-a62644f84728?w=1200&q=80"
};
...
const portfolio = [
  { id: 1, cat: "Editorial",   ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=700&q=80", title: "Spring drop · Aritzia" },
  { id: 2, cat: "Commercial",  ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=900&q=80", title: "Soho House · Miami" },
  { id: 3, cat: "Portrait",    ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1554384645-13eab165c24b?w=700&q=80", title: "Equinox · Member series" },
  { id: 4, cat: "Real Estate", ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&q=80", title: "The Standard · Property" },
  { id: 5, cat: "Editorial",   ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1496217590455-aa63a8350eea?w=700&q=80", title: "Vogue Business · Resort" },
  { id: 6, cat: "Commercial",  ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=900&q=80", title: "Horizon Rebrand" },
  { id: 7, cat: "Portrait",    ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=700&q=80", title: "Founder portraits" },
  { id: 8, cat: "Commercial",  ratio: "aspect-[16/10]",src: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=900&q=80", title: "Editorial campaign" },
  { id: 9, cat: "Real Estate", ratio: "aspect-[4/5]",  src: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=700&q=80", title: "Coral Gables residence" }
];
...
function Breadcrumb() {
  return (
    <div className="flex items-center gap-2 text-[11px] text-[var(--text-dim)] mb-6">
      <a href="Landing.html" className="hover:text-[var(--text)] transition-colors">Home</a>
      <span className="opacity-40">/</span>
      <a href="Find Creators.html" className="hover:text-[var(--text)] transition-colors">Find Creators</a>
      <span className="opacity-40">/</span>
      <a href="Find Creators.html?lane=photo" className="hover:text-[var(--text)] transition-colors">Photography</a>
      <span className="opacity-40">/</span>
...
function StatStrip() {
  const stats = [
    ...
    { v: creator.projects, l: "Projects Delivered", sub: "across 3 service lines" },
...
function Portfolio({ onOpen }) {
  const cats = ["All", "Editorial", "Commercial", "Portrait", "Real Estate"];
