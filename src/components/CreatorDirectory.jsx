  ...
  return (
    <div className="relative w-full min-h-screen">
      <div className="pointer-events-none fixed inset-0 -z-10" aria-hidden="true">
        <img src="/images/creatorbridge/backgrounds/08-sitewide/bg-cinematic-set.jpg" alt="" className="h-full w-full object-cover" style={{ opacity: 0.4, filter: 'brightness(0.85) saturate(1.1)' }} />
