    ...
    <div className="min-h-screen text-[var(--text)] relative z-10 pb-20">
      <div className="cb-home-wide mx-auto w-full px-5 sm:px-8 lg:px-14 2xl:px-16 pt-24">
        ...
        <div className="mb-8">
          ...
          <img src="/images/creatorbridge/backgrounds/pillar-photo-studio-subjects.jpg" alt="" className="pointer-events-none absolute inset-0 h-full w-full object-cover" style={{ opacity: 0.5, filter: 'brightness(0.78) saturate(1.05)' }} loading="lazy" />
