      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <aside className="space-y-6">
          <div className="relative min-h-[260px] overflow-hidden rounded-2xl border border-gold-500/18 bg-charcoal-950/70">
            <img src={clientSupportImage} alt="" className="absolute inset-0 h-full w-full object-cover opacity-70" onError={(e)=>{ if(!e.currentTarget.dataset.fb){ e.currentTarget.dataset.fb='1'; e.currentTarget.src='/images/creatorbridge/backgrounds/09-fallback/fallback-default-cover.jpg'; } }}/>
