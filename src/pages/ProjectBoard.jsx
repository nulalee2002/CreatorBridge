  ...
  return (
    <div className="w-full space-y-5 text-sans">
      ...
      <div className="relative h-32 rounded-xl overflow-hidden">
        <img src={coverImage} alt="" className="w-full h-full object-cover" onError={(e)=>{ if(!e.currentTarget.dataset.fb){ e.currentTarget.dataset.fb='1'; e.currentTarget.src='/images/creatorbridge/backgrounds/jakob-owens-ntqaFfrDdEA-unsplash.jpg'; } }} />
...
export function ProjectBoard({ dark }) {
  ...
  const projectBoardImage = '/images/creatorbridge/backgrounds/jakob-owens-ntqaFfrDdEA-unsplash.jpg';
        ...
        <div className={`relative overflow-hidden rounded-[28px] border p-6 md:p-8 mb-6 liquid-glass ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_380px] gap-6 items-stretch">
            ...
            <div className={`relative hidden min-h-[230px] overflow-hidden rounded-2xl border lg:block ${dark ? 'border-gold-500/18 bg-charcoal-950/70' : 'border-gray-200 bg-gray-50'}`}>
              <img src={projectBoardImage} alt="" className="absolute inset-0 h-full w-full object-cover" loading="lazy" onError={(e)=>{ if(!e.currentTarget.dataset.fb){ e.currentTarget.dataset.fb='1'; e.currentTarget.src='/images/creatorbridge/backgrounds/jakob-owens-B4f_Kx5jvpg-unsplash.jpg'; } }} />
