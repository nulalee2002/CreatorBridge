...
export const CLIENT_MINIMUM_PROJECT_NOTE =
  "Projects on CreatorBridge start at $250. Every booking is backed by secure payment protection and dispute support, and the minimum keeps each project worth a verified creator's time and those protections viable for both sides.";
...
export const CREATOR_MINIMUM_PROJECT_NOTE =
  'CreatorBridge projects start at $250. Set your packages and proposals at $250 or more, it keeps your work worth your time and keeps payment protection viable on every booking.';
