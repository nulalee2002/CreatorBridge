...
export const SEED_CREATORS = [
  ...
  // ── 1. Filmmaker / Videographer ───────────────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/featured-warehouse-film-set.jpg',
  ...
  // ── 3. Podcast Producer ──────────────────────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/featured-horizon-photographer.jpg',
  ...
  // ── 4. David Park — Video Production, LA ───────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/creator-video-on-location.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 6. Maya Chen — Short-form Social, Chicago ──────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/creator-video-studio.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 7. Aaron Wei — Color Grading, Seattle ──────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/creator-post-color-grade.jpg',
    primary_pillar: 'post_production',
  ...
  // ── 8. Naomi Greene — Brand films, Brooklyn ────────────────────
  {
    ...
    avatar: '/images/creatorbridge/handoff/photo-1531746020798-e6953c6e8e04.png',
    cover: '/images/creatorbridge/backgrounds/creator-video-field-shoot.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 10. Dre Williams — Event coverage, Atlanta ─────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/pillar-photo-studio-subjects.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 12. Marcus Bell — Motion + edit, Portland ──────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/featured-documentary-rooftop-crew.jpg',
    primary_pillar: 'post_production',
