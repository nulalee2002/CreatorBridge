...
export const SEED_CREATORS = [
  ...
  // ── 1. Filmmaker / Videographer ───────────────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/jakob-owens-ycExgCMRggc-unsplash.jpg',
  ...
  // ── 2. Photographer ──────────────────────────────────────────
  {
    ...
    cover: '/images/creatorbridge/handoff/photo-1542038784456-1ea8e935640e.png',
  ...
  // ── 3. Podcast Producer ──────────────────────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/elijah-merrell--qFWOJEEQh4-unsplash.jpg',
  ...
  // ── 4. David Park — Video Production, LA ───────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/luigi-ritchie-d4bQC7yVyoE-unsplash.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 6. Maya Chen — Short-form Social, Chicago ──────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/rob-wingate-UG9LOi8BJWQ-unsplash.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 7. Aaron Wei — Color Grading, Seattle ──────────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/bas-peperzak-hY07uZBVrGo-unsplash.jpg',
    primary_pillar: 'post_production',
  ...
  // ── 8. Naomi Greene — Brand films, Brooklyn ────────────────────
  {
    ...
    avatar: '/images/creatorbridge/handoff/photo-1531746020798-e6953c6e8e04.png',
    cover: '/images/creatorbridge/backgrounds/jose-p-ortiz-tzhZ_Py70xA-unsplash.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 10. Dre Williams — Event coverage, Atlanta ─────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/gordon-cowie-JbcOtH0W6UQ-unsplash.jpg',
    primary_pillar: 'video_production',
  ...
  // ── 12. Marcus Bell — Motion + edit, Portland ──────────────────
  {
    ...
    cover: '/images/creatorbridge/backgrounds/jj-rocha-NqPUto5vS10-unsplash.jpg',
    primary_pillar: 'post_production',
