...
// CALL_CONSENT_TEXT, so drift between the two files fails loudly instead
// of recording the wrong wording.
...
export const CALL_EXPECTATION_TEXT =
  'Video calls unlock after you book. Once the agreement is signed and the retainer is paid, you can schedule video calls inside CreatorBridge, recorded audio only so you both keep an accurate record.';
